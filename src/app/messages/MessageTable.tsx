...
export default function MassageTable({ messages }: Props) {
  ...
  const columns = [
    ...
    { key: "created", label: isOutbox ? "Data sent" : "Data received" },
  ...
  return (
    <Card className="flex flex-col gap-3 h-[80hv] overflow-auto">
      <Table
